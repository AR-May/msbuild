    ...
    internal class MSBuild : ITask, IMultiThreadableTask
    {
            ...
            TaskEnvironment taskEnvironment)
        {
            ...
            foreach (string[] targetList in targetLists)
            {
                ...
                BuildEngineResult result = await taskHost.InternalBuildProjects(ToStringArray(projectNames), targetList, projectProperties, undefinePropertiesPerProject, toolsVersions, true /* ask that target outputs are returned in the buildengineresult */, skipNonexistentTargets);
        ...
        /// <summary>
        /// Converts an array of AbsolutePath to an array of strings.
        /// </summary>
        /// <param name="absolutePaths">The array of AbsolutePath instances to convert.</param>
        /// <returns>An array of strings representing the paths.</returns>
        private static string[] ToStringArray(AbsolutePath[] absolutePaths)
        {
